...
map<long long, vector<int> > truth_tracks;
point truth_pos[200000], truth_mom[200000];
double truth_weight[200000];
long long truth_part[200000];
map<long long, double> part_weight;
map<long long, map<int, double> > metai_weight;
...
map<long long, point> start_pos;
map<long long, point> start_mom;
map<long long, int> part_q;
